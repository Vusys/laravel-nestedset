...
Blueprint::macro('nestedSetAggregate', function (string $column, string $type = 'sum_count', bool $lazy = false): void {});
Blueprint::macro('dropNestedSetAggregate', function (string $column, string $type = 'sum_count', bool $lazy = false): void {});
