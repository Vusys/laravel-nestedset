...
{
    #[Test]
    public function carbon_date_columns_compare_equal_when_same_instant(): void
    {
    ...
    #[Test]
    public function numeric_strings_compare_equal_to_their_int_counterparts(): void
    {
    ...
    #[Test]
    public function nested_json_arrays_compare_canonically_after_key_sort(): void
    {
    ...
    #[Test]
    public function actual_column_changes_still_surface_as_modified(): void
    {
