...
{
    #[Test]
    public function column_for_appends_suffix_to_display_column(): void
    {
    ...
    #[Test]
    public function column_for_does_not_drop_existing_underscores(): void
    {
    ...
    #[Test]
    public function avg_promotion_uses_the_existing_avg_companion_suffixes(): void
    {
