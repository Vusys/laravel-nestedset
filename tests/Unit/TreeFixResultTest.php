...
{
    public function test_stores_nodes_updated_and_errors(): void
    {
    ...
    public function test_has_errors_is_true_when_any_error_count_is_nonzero(): void
    {
    ...
    public function test_has_errors_is_false_when_all_error_counts_are_zero(): void
    {
    ...
    public function test_has_errors_is_false_for_empty_errors_array(): void
    {
