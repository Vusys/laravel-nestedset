...
final class CustomPrimaryKeyTest extends TestCase
{
    ...
    #[Test]
    public function save_as_root_uses_custom_primary_key(): void
    {
    ...
    #[Test]
    public function append_to_node_resolves_via_custom_pk(): void
    {
        $root = new Tag(['name' => 'Root', 'tickets' => 0]);
        $root->saveAsRoot();
        $root = $root->refresh();
    ...
    #[Test]
    public function move_existing_node_via_custom_pk_keeps_tree_intact(): void
    {
    ...
    #[Test]
    public function fix_tree_repairs_via_custom_pk(): void
    {
    ...
    #[Test]
    public function orphan_detection_uses_custom_pk(): void
    {
    ...
    #[Test]
    public function aggregate_delta_path_uses_custom_pk(): void
    {
        $root = new Tag(['name' => 'Root', 'tickets' => 0]);
        $root->saveAsRoot();
        $root = $root->refresh();
    ...
    #[Test]
    public function fix_aggregates_repairs_via_custom_pk(): void
    {
        $root = new Tag(['name' => 'Root', 'tickets' => 0]);
        $root->saveAsRoot();
        $root = $root->refresh();
    ...
    #[Test]
    public function fix_aggregates_chunked_path_uses_custom_pk(): void
    {
    ...
    #[Test]
    public function hard_delete_leaf_closes_gap_via_custom_pk(): void
    {
        $root = new Tag(['name' => 'Root', 'tickets' => 0]);
        $root->saveAsRoot();
        $root = $root->refresh();
