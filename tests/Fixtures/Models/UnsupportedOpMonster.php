 ...
 * the PHP listener path cannot compute (collection / quantile / derived
 * ops raise an AggregateConfigurationException). The definitions are
 * constructible — only bitwise ops are refused at construction — so the
 * guard fires lazily when a fresh read is taken.
 *
