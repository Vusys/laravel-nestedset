...
- Telemetry events — `NodeMoved`, `FixTreeCompleted`,
  `FixAggregatesCompleted`, and a handful of others — fired on
  Laravel's event bus around every meaningful operation. See
